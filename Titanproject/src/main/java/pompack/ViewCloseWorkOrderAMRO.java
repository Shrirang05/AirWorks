...
public class ViewCloseWorkOrderAMRO 
{
	private WebDriver driver;
	private Actions Act;
	private Select SE;
	
	public ViewCloseWorkOrderAMRO (WebDriver driver)
	{
		this.driver = driver;
	...
	@FindBy (xpath ="//span[text()='20-380-00/20-380-00-01']")
	...
	{  
		Textdescription.sendKeys("Test text description");
	}
