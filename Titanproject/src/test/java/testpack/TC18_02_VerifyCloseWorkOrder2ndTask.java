...
public class TC18_02_VerifyCloseWorkOrder2ndTask extends TestBaseClassPreServer
{
...
//	log.info("Click on ON Serial No");
	...
	// scenario for Active/InActive Material Grid
	
	VCWAMRO2.ClickonCheckboxforInactive();
	log.info("Click on Checkbox for Inactive");
	
	VCWAMRO2.ClickonInactiveRecord();
	log.info("Click on Inactive Record");
	...
	VCWAMRO2.ClickonCheckboxforInactive();
	log.info("Click on Checkbox for Active");
	
	VCWAMRO2.ClickonActiveRecord();
	log.info("Click on Active Record");
	...
	// scenario for Active/InActive Tool Grid
	
	VCWAMRO2.ClickonToolCheckboxforInactive();
	log.info("Click on Tool Checkbox for Inactive");
	
	VCWAMRO2.ClickonInactiveRecordforTool();
	log.info("Click on Inactive Record for tool");
	...
	VCWAMRO2.ClickonToolCheckboxforInactive();
	log.info("Click on Tool Checkbox for Active");
	
	VCWAMRO2.ClickonActiveRecordforTool();
	log.info("Click on Active Record for Tool");
